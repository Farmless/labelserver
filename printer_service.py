...
class LabelPrinterService:
    def __init__(self, config: Dict[str, Any], backend_class: Any):
        self.config = config
    ...
    def print_label(self, image_data: str, label_size: str, threshold: int = 70, rotate: str = 'auto') -> bool:
        """
        ...
        try:
            ...
            logger.info(f"Label printed successfully (size: {label_size}, threshold: {threshold}, rotate: {rotate})")
            return True
